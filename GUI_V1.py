...
def visualizar():
    ...
    if cap is not None:
        ...
        if ret == True:
            results = model.predict(frame, verbose=True, agnostic_nms=True, conf=0.50, imgsz=640, device=0)
...
inicio = 1
Titulo_fecha_exp = pantalla.create_text(323, 320, text=f"Número de Parte: ", font=("Helvetica", 40, "bold"), fill="black", anchor=tk.NW)
Titulo_lot_number = pantalla.create_text(323, 502, text=f"Fecha de Expiración: ", font=("Helvetica", 40, "bold"), fill="black", anchor=tk.NW)
Titulo_part_number  = pantalla.create_text(323, 685, text=f"Número de Lote: ", font=("Helvetica", 40, "bold"), fill="black", anchor=tk.NW)
